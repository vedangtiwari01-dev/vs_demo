#!/usr/bin/env python3
"""Script to update the SOP extraction prompt in prompts.py"""

# Read the improved prompt
IMPROVED_PROMPT_CONTENT = """# OUTPUT FORMAT
...
new_lines.append('\n')
new_lines.append(IMPROVED_PROMPT_CONTENT)
new_lines.append('\n"""\n')
...
print("Updated SOP_RULE_EXTRACTION_PROMPT with improved version")
